...
const Hero = () => {
    ...
    return (
        <section id="home" className="min-h-screen flex items-center justify-center gradient-bg text-blue-900 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                >
                    ...
                    >
                        <motion.a
                            href="/Amresh_Kumar_Resume.pdf" // Make sure this file exists in your /public folder
                            download
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
